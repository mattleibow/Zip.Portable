    ...
    public partial class ZipForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var files = Directory.GetFiles(this.tbDirectoryToZip.Text, this.tbSelectionToZip.Text, this.chkRecurse.Checked ? SearchOption.AllDirectories : SearchOption.TopDirectoryOnly);
                this.listView2.BeginUpdate();
