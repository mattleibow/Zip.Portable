...
namespace Ionic.Zip
{
    public partial class ZipFile
    {
        ...
        {
            return CheckZip(zipFileStream, null, null);
        }
        ...
        {
            return CheckZip(zipFileStream, fixedZipFileStream, null);
        }
...

        {
            ...
            try
            {
                ...
                zip1 = ZipFile.Read(stream, new ReadOptions { FullScan = true });
        ...
        public static bool CheckZipPassword(Stream zipFileStream, string password)
        {
            ...
            try
            {
                using (ZipFile zip1 = ZipFile.Read(zipFileStream))
                {
